...
NOTE: these slides refer to repositories which have changed (4th Mar 2022).
</div>
...
- [Wiki](https://github.com/layik/eAtlas/wiki/Using-TGVE#using-github-pages) entry to do this
    (1) Use the [template](https://github.com/tgve/app/) repository & Setup github pages on new github settings
