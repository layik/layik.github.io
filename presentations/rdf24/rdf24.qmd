...
- Role of RDF (Knowledge Graphs) in the age of Transformers (~ 10 mins)
- Q&A (~10 mins)
...
<a href="https://asciinema.org/a/fzvuExSAHTuTfhmXaTcZKQ5yl?t=100" target="_blank"><img src="https://asciinema.org/a/fzvuExSAHTuTfhmXaTcZKQ5yl.svg" /></a>
...
- One youtube link that is useful
- Bigram generator to explain "transformers"
- What you already know/heard about ChatGPT/Bard etc


:::
::: {.column width="60%"}
<iframe style="text-align: center; width: 90vw; height: 90vh; border: none;" src="https://www.youtube.com/embed/PaCmpygFfXo?si=Nt6U0ctBFjhmJOD4&amp;start=1264" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
:::
:::
...
- and Knowledge Aware Validation
...
- One thesis by (Canellas 2023) focuses on news streams
...
- Fernández Cañellas, Dèlia. "Knowledge graph population from news streams." (2023). PhD thesis.
